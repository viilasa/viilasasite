import { forwardRef, useMemo, useRef, useEffect, MutableRefObject, RefObject, Key } from "react";
        ...
        >
            {words.map((word: string, wordIndex: Key | null | undefined) => (
                ...
                >
                    ...
                    {wordIndex !== null && Number(wordIndex) < words.length - 1 && (
                        <span key={`space-${wordIndex}`} style={{ display: "inline-block" }}>&nbsp;</span>
                    )}
                </span>
            ))}
